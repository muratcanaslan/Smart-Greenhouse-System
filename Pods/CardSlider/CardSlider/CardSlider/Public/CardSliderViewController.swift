...
///
/// Needs CardSliderDataSource tod show data.
...
open class CardSliderViewController: UIViewController, UIScrollViewDelegate {
    ...
    @IBOutlet private var goBackButton: UIButton!{
        didSet{
            ...
            goBackButton.titleLabel?.font = UIFont.boldSystemFont(ofSize: 16)
            goBackButton.backgroundColor = .red
            goBackButton.translatesAutoresizingMaskIntoConstraints = false
            goBackButton.topAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.topAnchor, constant: 20).isActive = true
            goBackButton.trailingAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.trailingAnchor, constant: -20).isActive = true
